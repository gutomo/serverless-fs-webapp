...
import { CustomAppLayout } from './components/common/common-components';
...
const profileActionItems: ButtonDropdownProps['items'] = [
  {
    id: 'documentation',
    text: 'Documentation',
    href: '#',
...
const profileActions: ButtonDropdownProps.ItemOrGroup[] = [
  ...
  { id: 'signout', text: 'Sign out', iconName: 'settings' },
];
...
const tableItems: TableProps['items'] = [
  {name: 'n', type: 't', size: 6, description: 'desc'},
  {name: 'n2', type: 't', size: 7, description: 'desc2'}
]
