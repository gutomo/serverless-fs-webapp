...
import ContactsPage from './pages/masterdata/contacts/page';
import ProductsPage from './pages/masterdata/products/page';
        ...
        <div>
          <Routes>
            ...
            <Route path="/section1" element={<Outlet />}>
              ...
              <Route path="items/:sk" element={<ViewItemPage />} />
            </Route>
